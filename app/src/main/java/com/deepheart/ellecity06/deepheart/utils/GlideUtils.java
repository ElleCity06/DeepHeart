...
public class GlideUtils {
  ...
  //默认加载
  public static void loadImageView2(Context mContext, String path, ImageView mImageView) {
    Glide.with(mContext)
         .load(path)
  ...
  public static void loadImageViewForRes(Context mContext,
                                         @DrawableRes Integer resourceId, ImageView mImageView)
  {
    Glide.with(mContext)
         .load(path)
  ...
  //加载圆形图片
  public static void setCircleView(Context mContext, ImageView imageView, int errorImageview, int loadingImageview, String path) {
    Glide.with(mContext)
         .load(path)
         .error(errorImageview)
