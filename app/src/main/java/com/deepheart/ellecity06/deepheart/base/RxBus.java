 ...
 * @author ellecity06
 * @time 2018/5/9 9:30
 * @des TODO 用Rxjava 实现的EventBus 事件订阅，收发
 */
public class RxBus {
    ...
    public <T> Observable<T> register(@NonNull Object tag) {
        ...
        LogUtil.d("RxBus", "register ==== tag = " + tag + "size = " + subjectList.size());
        return subject;
    }
    ...
    public RxBus unregister(@NonNull Object tag,
        ...
        if (null != subjects) {
            ...
            if (isEmpty(subjects)) {
                subjectMapper.remove(tag);
                LogUtil.d("RxBus", "unregister ==== tag = " + tag + ", size = " + subjects.size());
            }
        }
        return getInstance();
    }
