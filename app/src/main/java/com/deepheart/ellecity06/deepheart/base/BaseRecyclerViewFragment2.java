...
public class BaseRecyclerViewFragment2<M extends BaseModel, P extends BasePresenter> extends RxFragment implements BaseQuickAdapter.RequestLoadMoreListener {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        ...
        mInflate = inflater.inflate(R.layout.base_recyclerview_fragment, container, false);
        emptyView = getActivity().getLayoutInflater().inflate(R.layout.empty_view, (ViewGroup) mInflate, false); // 空视图
        loadingView = View.inflate(getActivity(), R.layout.loading_view, (ViewGroup) mInflate); //加载中的视图
        initView(mInflate);
        return mInflate;
    }
//
